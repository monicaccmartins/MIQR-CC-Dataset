...
This folder contains a Jupyter Notebook (`preprocessing.ipynb`) used to preprocess the MIQR-CC dataset. The notebook includes utilities to:
...
- `preprocessing.ipynb` - main notebook with detection / partitioning / plotting code
...
- image files referenced by `raw_image_path` (not included in this folder).
